angular.module('gi.commerce', ['gi.util', 'gi.security']).value('version', '0.6.10-dev').config([
...
angular.module('gi.commerce').directive('giAddressFormFields', [
  'giCart', 'giI18n', function(Cart, I18n) {
    return {
      restrict: 'E',
