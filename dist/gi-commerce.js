    ...
    return {
      ...
      link: function($scope, elem, attrs) {
        ...
        $scope.isPropertyValidationError = function(prop) {
          return $scope.customerForm[prop].$invalid && $scope.customerForm[prop].$touched && $scope.customerForm[prop].$dirty;
        };
        $scope.isPropertyValidationSuccess = function(prop) {
          return $scope.customerForm[prop].$valid && $scope.customerForm[prop].$touched && $scope.customerForm[prop].$dirty;
        };
